...
servoindex3.write(135);// 0 is 135 wrist (rotation of -15 in between 0 and 180)
servoindex2.write(0); //110 maximum (ring finger)

servoindex4.write(0); //110 maximum (index finger)
servoindex5.write(0); //100 maximum (thumb)
servoindex6.write(0); //100 maximum (pinky)
servoindex7.write(0); //90 maximum (middle finger)
delay(5000);
